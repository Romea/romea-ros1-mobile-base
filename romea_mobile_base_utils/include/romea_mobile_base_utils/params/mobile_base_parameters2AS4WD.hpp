...
inline core::MobileBaseInfo2AS4WD get_mobile_base_info_2AS4WD(const ros::NodeHandle & nh)
{
  return {
    get_two_wheeled_axles_info(ros::NodeHandle(nh, "geometry")),
    get_steering_angle_control_info(ros::NodeHandle(nh, "axles_steering_control")),
