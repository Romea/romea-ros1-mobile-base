...
inline core::MobileBaseInertia get_inertia_info(const ros::NodeHandle & nh)
{
  return {
    load_param<double>(nh, "mass"),
    loadEigenVector<Eigen::Vector3d>(nh, "center"),
    load_param<double>(nh, "z_moment")};
}
