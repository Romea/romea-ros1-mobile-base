...
inline core::MobileBaseInfo1FAS2FWD get_mobile_base_info_1FAS2FWD(const ros::NodeHandle & nh)
{
  return {
    get_two_wheeled_axles_info(ros::NodeHandle(nh, "geometry")),
    get_steering_angle_control_info(ros::NodeHandle(nh, "front_axle_steering_control")),
    get_wheel_speed_control_info(ros::NodeHandle(nh, "front_wheels_speed_control")),
