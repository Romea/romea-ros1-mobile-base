...
inline core::MobileBaseInfo4WS4WD get_mobile_base_info_4WS4WD(const ros::NodeHandle & nh)
{
  return {
    get_two_wheeled_axles_info(ros::NodeHandle(nh, "geometry")),
    get_steering_angle_control_info(ros::NodeHandle(nh, "wheels_steering_control")),
